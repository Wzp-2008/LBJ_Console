...
object BluetoothHelper {
    ...
    fun deviceToMap(
        ...
        rssi: Int? = null,
        discoveredClass: BluetoothClass? = null,
    ): Map<String, Any?> {
        ...
        val map = mutableMapOf<String, Any?>(
            ...
            "classOfDevice" to runCatching {
                classOfDevice(discoveredClass ?: device.bluetoothClass)
            }.getOrNull(),
        )
    ...
    private fun classOfDevice(bluetoothClass: BluetoothClass?): Int? {
        bluetoothClass ?: return null
        var value = bluetoothClass.deviceClass
        val services = intArrayOf(
        ...
        for (service in services) {
            if (bluetoothClass.hasService(service)) value = value or service
        }
