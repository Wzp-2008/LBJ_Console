...
/// | classOfDevice | Yes | Yes | No | No | No |
///
/// {@category Models}
class BtcDevice {
  ...
  /// The 24-bit Bluetooth Class of Device value when the platform exposes it.
  ...
  factory BtcDevice.fromMap(Map<dynamic, dynamic> map) {
    return BtcDevice(
      ...
      classOfDevice: map['classOfDevice'] as int?,
    );
  }
  ...
  BtcDevice mergedWith(BtcDevice other) => BtcDevice(
    ...
    classOfDevice: other.classOfDevice ?? classOfDevice,
  );
